...
<div class="box-body">
<div class="row">						
<center><H2>deposit manager</H2></center>
</div>
</div>
</div>
</div>
...
if(!$admin_statusprob==1){
			...
			if ($fee->AddUserPayment($uidprob,$uppaymentdprob,0,$uptrack_codeprob,'deposit approve by admin',10))
					{
						$fee = new ManageFees();
						$uid=$uidprob;
...
$query = "ORDER BY `nim_user_payments_app`.`admin_status` ASC";			
$discountList = $fee->GetPaymentListapp($query);			
